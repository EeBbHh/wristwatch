...
import bitmaptools,terminalio,digitalio,rtc,vectorio
import time,math
from adafruit_display_text.bitmap_label import Label
gc.collect()
displayio.release_displays()
gc.collect()
shared_bitmap=displayio.Bitmap(240,240,3)
shared_bitmap.fill(0)
gc.collect()

CX=120;CY=120
CLK_BG=0;CLK_GREEN=1;CLK_RED=2
COLOR_CYAN=0x00FFFF;COLOR_RED=0xFF2200;COLOR_PINK_PURPLE=0xCC44AA
...
def run_time_set():
    ...
    for f in range(len(FIELDS)):
        ...
        while True:
            if both_held():set_label.text="";return
