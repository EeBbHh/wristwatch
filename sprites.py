...
def build_sprites():
    ...
    head_s1=filled_ellipse(CX-22,CY+15,13,9,-20);stem_s1=thick_vline(CX-11,CY+7,CY-22,4)
    head_s2=filled_ellipse(CX+12,CY+5,13,9,-20);stem_s2=thick_vline(CX+23,CY-3,CY-22,4)
    beam_s1=filled_rect(CX-11,CY-26,35,7);beam_s2=filled_rect(CX-11,CY-17,35,7)
    SPRITE["sixteenth"]=merge(head_s1,stem_s1,head_s2,stem_s2,beam_s1,beam_s2);del head_s1,stem_s1,head_s2,stem_s2,beam_s1,beam_s2;gc.collect()
